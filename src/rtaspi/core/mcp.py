...
class MCPBroker:
        ...
        with self.lock:
            ...
            if topic in self.topics:
                ...
                if client_id in self.topics[topic]:
                    ...
                    logger.debug(f"Klient {client_id} anulował subskrypcję tematu: {topic}")
    ...
    def publish(self, client_id, topic, message):
        ...
        with self.lock:
            ...
            logger.debug(f"Wiadomość opublikowana na temat {topic} doręczona do {delivered} subskrybentów")
