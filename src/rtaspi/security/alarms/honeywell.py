...
class HoneywellAlarmSystem(AlarmSystem):
    ...
    def connect(self) -> bool:
        ...
        try:
            # Authenticate
            response = self._api_call('authenticate', {
    ...
    def arm(self, mode: str = 'away') -> bool:
        ...
        try:
            ...
            # Send arm command
            response = self._api_call('arm_panel', {
    ...
    def disarm(self, code: Optional[str] = None) -> bool:
        ...
        try:
            ...
            # Send disarm command
            response = self._api_call('disarm_panel', {
                'locationId': self.location_id,
                'deviceId': self.device_id,
                'userCode': code or ''
            })
    ...
    def bypass_zone(self, zone_id: str) -> bool:
        ...
        try:
            ...
            # Send bypass command
            response = self._api_call('bypass_zone', {
                'locationId': self.location_id,
                'deviceId': self.device_id,
                'zoneId': zone_id
            })
    ...
    def unbypass_zone(self, zone_id: str) -> bool:
        ...
        try:
            ...
            response = self._api_call('clear_bypass', {
                'locationId': self.location_id,
                'deviceId': self.device_id,
                'zoneId': zone_id
            })
    ...
    def _api_call(self, endpoint: str, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    def _update_state(self) -> bool:
        ...
        try:
            # Get panel status
            response = self._api_call('get_panel_status', {
                'locationId': self.location_id,
                'deviceId': self.device_id
            })
            ...
            # Get zone status
            response = self._api_call('get_zone_status', {
                'locationId': self.location_id,
                'deviceId': self.device_id
            })
            ...
            # Get recent events
            response = self._api_call('get_events', {
                'locationId': self.location_id,
                'deviceId': self.device_id,
            ...
            for event_data in events:
                try:
                    ...
                    event = AlarmEvent(
                        ...
                        type=event_type,
                        zone_id=str(event_data.get('zoneId')) if event_data.get('zoneId') else None,
                        details={
