...
class WindowCapture:
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            composite.composite_redirect_window(
                self._display.screen().root, composite.RedirectAutomatic
            )
    ...
    def find_window_by_name(self, name: str) -> bool:
        ...
        try:
            ...
            window_ids = root.get_full_property(
                self._display.intern_atom("_NET_CLIENT_LIST"), X.AnyPropertyType
            ).value
    ...
    def capture_window(self) -> Optional[bytes]:
        ...
        try:
            ...
            data = data.reshape(
                self._window_geometry.height, self._window_geometry.width, 4  # RGBA
            )
